...
public class OffsetLimitInterceptor implements Interceptor{
	...
	public Object intercept(final Invocation invocation) throws Throwable {
        ...
        queryArgs[MAPPED_STATEMENT_INDEX] = copyFromNewSql(ms,boundSql,dialect.getPageSQL(), dialect.getParameterMappings(), dialect.getOldParameterObject());
        queryArgs[PARAMETER_INDEX] = dialect.getOldParameterObject();
